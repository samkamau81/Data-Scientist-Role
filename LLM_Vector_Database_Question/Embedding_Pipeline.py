...
def load_data(file_path):
    """Load the product review data from CSV or JSONL."""
    if file_path.endswith('.csv'):
        ...
        raise ValueError("Unsupported file format. Please provide CSV or JSONL file.")
...
if __name__ == "__main__":
    # Initialize and save
    vector_db = ReviewVectorDB().initialize("product_reviews.csv")
